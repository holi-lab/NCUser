...
def parse_args() -> RunConfig:
    ...
    parser.add_argument("--non-coll-yaml", type=str, default="non_coll.yaml", help="YAML file to use for non-collaborative configuration")
    ...
    return RunConfig(
        ...
        non_coll_yaml=args.non_coll_yaml,
    )
